...
// ── Contact form — validate, then submit to FormSubmit (AJAX endpoint)
...
if (contactForm) {
  contactForm.addEventListener('submit', function(e) {
    ...
    // instead of redirecting, so we can show our own success message.
    const ajaxAction = this.action.replace('https://formsubmit.co/', 'https://formsubmit.co/ajax/');
    ...
    fetch(ajaxAction, {
      ...
      .then(data => {
        if (data.success === 'true' || data.success === true) {
          ...
          alert('Something went wrong sending your message. Please call us or try again.');
          if (submitBtn) {
